...
/// }
/// ```
#[macro_export] macro_rules! k8s_if_1_28 { ($($tt:tt)*) => { $($tt)* }; }
...
#[macro_export] macro_rules! k8s_if_le_1_28 { ($($tt:tt)*) => { $($tt)* }; }
